...
Fp step_verify_bytes(void* ctx, HostBridge host, size_t steps, size_t cycle, Fp** args) {
  ...
  // loc("rv32im_v1::Top/rv32im_v1::Code/OneHot/hot[7](Reg)"("./zirgen/components/mux.h":49:25))
  auto x10 = args[0][8 * steps + ((cycle - 0) & mask)];
  assert(x10 != Fp::invalid());
  // loc("rv32im_v1::Top/rv32im_v1::Code/OneHot/hot[0](Reg)"("zirgen/circuit/rv32im/v1/edsl/top.cpp":78:27))
  ...
  if (x5 != 0) {
    ...
    // loc("rv32im_v1::Top/BytesHeader/BytesPlonkElement/Reg"("zirgen/components/bytes.cpp":62:42))
    auto x55 = args[2][0 * steps + ((cycle - 1) & mask)];
    assert(x55 != Fp::invalid());
    // loc("rv32im_v1::Top/BytesHeader/BytesPlonkElement/Reg"("zirgen/components/bytes.cpp":63:40))
    ...
    // loc("rv32im_v1::Top/BytesHeader/BytesPlonkElement/Reg"("./zirgen/compiler/edsl/component.h":154:27))
  ...
  if (x10 != 0) {
    ...
    // loc("rv32im_v1::Top/mux(Mux)/bytes_fini(rv32im_v1::BytesFiniStep)/PlonkFini/BytesPlonkElement/Reg"("./zirgen/compiler/edsl/component.h":154:27))
