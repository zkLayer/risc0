...
extern "C" {
    pub(crate) fn risc0_circuit_recursion_string_ptr(str: *const RawString) -> *const c_char;

    pub(crate) fn risc0_circuit_recursion_string_free(str: *const RawString);

    pub(crate) fn risc0_circuit_recursion_step_compute_accum(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_recursion_step_verify_accum(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_recursion_step_exec(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_recursion_step_verify_bytes(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_recursion_step_verify_mem(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_recursion_poly_fp(
        cycle: usize,
        steps: usize,
